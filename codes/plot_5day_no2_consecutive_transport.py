...
if __name__=='__main__':
    ...
    for wd in eventDict.keys():
        ...
        ax.grid(True)
        ax.set_ylabel(r'$NO_2$ Conc. (${\mu}g/m^3$)')
        ...
        ax.set_title('(f) Average $NO_2$ Concentration of Greap Taipei Area in 5-Day Pollution Episode')
        ...
        plt.savefig(f'../figures/consecutive_scenario.png')
