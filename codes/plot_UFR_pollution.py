...
if __name__=='__main__':
    ...
    for i,wd in enumerate(wdList):
        ...
        rOrange.append((conc>=35.5).sum()/conc.shape[0]*100)
        rRed.append(pPolluted_TW)
    ...
    plt.suptitle('$PM_{2.5}$ Pollution and Enhancement Index under Various Flow Regime[%d-%d]'%(yr_start,yr_end),fontsize=30)
    plt.savefig('../bifurcation_enh_tw_without_wind.png')
